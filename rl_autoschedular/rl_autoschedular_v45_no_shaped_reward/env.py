from rl_autoschedular_v45_no_shaped_reward.state import OperationState, BenchmarkFeatures, OperationFeatures, IteratorType
...
from rl_autoschedular_v45_no_shaped_reward.actions import Action, TiledFusion
...
class Env:
    ...
    def __shaped_reward(self, old_features: OperationFeatures, new_features: OperationFeatures, action: Action) -> float:
        ...
        ABLATION: This method is disabled and always returns 0.0.
        """
        return 0.0
