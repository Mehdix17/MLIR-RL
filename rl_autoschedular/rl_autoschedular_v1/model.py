...
from rl_autoschedular_v1.actions import ActionSpace, Interchange
from rl_autoschedular_v1.observation import (
    OpFeatures,
    ActionHistory,
    ProducerOpFeatures,
    HardwareFeatures,
...
class LSTMEmbedding(nn.Module):
    def __init__(self):
        ...
        self.output_size = embedding_size + ActionHistory.size() + HardwareFeatures.size()
    ...
    def forward(self, obs: torch.Tensor) -> torch.Tensor:
        ...
        return torch.cat((
            ...
            Observation.get_part(obs, ActionHistory),
            hardware_feats,
        ), 1)
