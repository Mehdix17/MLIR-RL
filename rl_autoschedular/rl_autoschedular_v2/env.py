from rl_autoschedular_v2.state import OperationState, BenchmarkFeatures, OperationFeatures, IteratorType
from rl_autoschedular_v2.benchmarks import Benchmarks
from typing import Optional
from rl_autoschedular_v2.execution import Execution
from rl_autoschedular_v2.actions import Action, TiledFusion
    ...
    def apply_and_run_sequence(self, seq: list[list[Action]]) -> tuple[list[float], float, Optional[int], bool]:
        ...
        try:
            ...
            for run_idx in range(num_runs):
                run_time, run_ok, run_miss = Execution().execute_code(transformed_code, self.benchmark_data.bench_name, seq)
                if run_ok:
