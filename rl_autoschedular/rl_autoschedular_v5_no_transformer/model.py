...
from rl_autoschedular_v5_no_transformer.actions import ActionSpace, Interchange
from rl_autoschedular_v5_no_transformer.observation import OpFeatures, ActionHistory, ProducerOpFeatures, Observation
from rl_autoschedular_v5_no_transformer.state import OperationType
...
class LSTMEmbedding(nn.Module):
    """LSTM-based embedding layer for producer-consumer encoding (paper_original architecture).

    Encodes operation features of both the consumer and producer into a dense
    embedding using LSTM layers (ablated against the V5 TransformerEmbedding).
    """
