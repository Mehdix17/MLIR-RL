...
from rl_autoschedular_v45_no_transformer.actions import ActionSpace, Interchange
from rl_autoschedular_v45_no_transformer.observation import OpFeatures, ActionHistory, ProducerOpFeatures, HardwareFeatures, Observation, NumLoops
from rl_autoschedular_v45_no_transformer.state import OperationType
...
class LSTMEmbedding(nn.Module):
    def __init__(self):
        ...
        # Use 512 as hidden size to match the backbone's input
        self.hidden_size = 512

        self.output_size = self.hidden_size + ActionHistory.size() + HardwareFeatures.size()
        ...
        self.lstm = nn.LSTM(512, self.hidden_size)
    ...
    def forward(self, obs: torch.Tensor) -> torch.Tensor:
        ...
        return torch.cat((final_hidden.squeeze(0), action_history, hardware_feats), 1)
