...
def create_benchmark_suite():
    ...
    model_info = suite.save_pytorch_models("benchmarks/pytorch")
    
    # Export to MLIR format
    print("\n2. Exporting to MLIR format...")
    mlir_files = suite.export_to_mlir_format("benchmarks/mlir")
    ...
    metadata = {
        ...
        "pytorch_dir": "benchmarks/pytorch",
        "mlir_dir": "benchmarks/mlir",
    ...
    print(f"✓ PyTorch models: benchmarks/pytorch/")
    print(f"✓ MLIR files: benchmarks/mlir/")
