...
# Paths
INPUT_CSV  = "plots/multi_hardware/jubail/graph2_jubail_optype.csv"
OUTPUT_PNG = "plots/multi_hardware/jubail/graph2_jubail_operation.png"
...
ax.set_yticklabels(["1.0x", "2.0x", "3.0x", "4.0x", "5.0x"], fontsize=15)
...
ax.set_title("Multi-Hardware: Jubail \u2014 by Operation Type", fontsize=24, fontweight='bold')
