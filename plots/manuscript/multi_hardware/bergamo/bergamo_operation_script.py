...
# Paths
INPUT_CSV  = "plots/multi_hardware/bergamo/graph2_bergamo_optype.csv"
OUTPUT_PNG = "plots/multi_hardware/bergamo/graph2_bergamo_operation.png"
...
ax.set_yticks([1.0, 2.0, 6.0])
ax.set_yticklabels(["1.0x", "2.0x", "6.0x"], fontsize=15)
...
ax.set_title("Multi-Hardware: Bergamo \u2014 by Operation Type", fontsize=24, fontweight='bold')
