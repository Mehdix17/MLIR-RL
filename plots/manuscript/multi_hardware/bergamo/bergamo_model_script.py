...
# Paths
INPUT_CSV  = "plots/multi_hardware/bergamo/graph2_bergamo_model.csv"
OUTPUT_PNG = "plots/multi_hardware/bergamo/graph2_bergamo_model.png"
...
ax.set_title("Multi-Hardware: Bergamo \u2014 by Model", fontsize=24, fontweight='bold')
