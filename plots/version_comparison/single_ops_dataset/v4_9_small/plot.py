#!/usr/bin/env python3
"""Plot V4.9-Small geometric mean speedup evolution across checkpoints."""
...
CSV_PATH = os.path.join(SCRIPT_DIR, "v4_9_small.csv")
PNG_PATH = os.path.join(SCRIPT_DIR, "v4_9_small.png")
...
ax.set_title("V4.9-Small (Transformer) \u2014 Single Ops: Geometric Mean Speedup", fontsize=16, fontweight="bold")
