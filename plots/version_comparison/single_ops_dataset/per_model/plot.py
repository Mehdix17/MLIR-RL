#!/usr/bin/env python3
"""Plot grouped bar chart of geometric mean speedup by model type."""
...
INPUT_CSV = os.path.join(os.path.dirname(SCRIPT_DIR), "per_model.csv")
OUTPUT_PNG = os.path.join(SCRIPT_DIR, "per_model.png")
...
ax.set_title("Single Ops: Speedup by Model (Best Checkpoint)", fontsize=18, fontweight="bold")
