...
# Paths
INPUT_CSV  = "plots/multi_hardware/dalma/graph2_dalma_model.csv"
OUTPUT_PNG = "plots/multi_hardware/dalma/graph2_dalma_model.png"
...
ax.set_title("Multi-Hardware: Dalma \u2014 by Model", fontsize=24, fontweight='bold')
