...
# Usage:
#   sbatch scripts/bergamo_eval.sh config/v45_no_hw_blocks.json
#   EVAL_START=400 FORCE_RUN_ID=1 sbatch scripts/bergamo_eval.sh config/v45_no_hw_blocks.json
...
# Config Resolution
CONFIG="${1:-$PROJECT_ROOT/config/v45_no_hw_blocks.json}"
if [[ "$CONFIG" != /* ]]; then
