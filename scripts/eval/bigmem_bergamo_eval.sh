...
# Usage:
#   EVAL_START=400 EVAL_END=1100 FORCE_RUN_ID=1 sbatch scripts/bigmem_bergamo_eval.sh config/old_dataset/ablation/v45_no_reward_blocks.json
...
CONFIG="${1:-$PROJECT_ROOT/config/old_dataset/ablation/v45_no_reward_blocks.json}"
if [[ "$CONFIG" != /* ]]; then
