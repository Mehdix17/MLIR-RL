...
#SBATCH --output=/scratch/mb10856/MLIR-RL/logs/eval_nohw_norw_ju_%j.out
#SBATCH --error=/scratch/mb10856/MLIR-RL/logs/eval_nohw_norw_ju_%j.err
...
echo "=========================================="
echo "No-HW-No-Reward Jubail Evaluation"
echo "Checkpoint: 1100"
echo "Cluster: Jubail (AMD EPYC 7742, 128c)"
echo "Benchmarks: eval_base.json (2163)"
echo "=========================================="

export EVAL_LABEL=jubail
