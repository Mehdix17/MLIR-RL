#!/bin/bash
#SBATCH --job-name=mlir-eval-norew-dal
#SBATCH --partition=compute
#SBATCH --constraint=dalma
#SBATCH --mem=64G
#SBATCH --cpus-per-task=28
#SBATCH --time=3-00:00:00
#SBATCH --output=/scratch/mb10856/MLIR-RL/logs/eval_norew_dalma_%j.out
#SBATCH --error=/scratch/mb10856/MLIR-RL/logs/eval_norew_dalma_%j.err
#SBATCH --mail-type=END,FAIL

set -e

# Usage:
#   sbatch scripts/eval/dalma_eval_no_reward.sh
#   Evaluates No-Reward checkpoint 1100 on Dalma (Intel Xeon E5-2680 v4)
...
export FORCE_RUN_ID=dalma

echo "=========================================="
echo "No-Reward Dalma Evaluation started at $(date)"
echo "Implementation: $AUTOSCHEDULER_IMPL"
echo "Config:         $CONFIG_FILE_PATH"
echo "Checkpoint:     1100"
echo "Cluster:        Dalma (Intel Xeon E5-2680 v4, 28 cores)"
