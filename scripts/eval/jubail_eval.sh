#!/bin/bash
#SBATCH --job-name=mlir-eval-jubail
#SBATCH --partition=compute
#SBATCH -C jubail
#SBATCH --mem=32G
#SBATCH --cpus-per-task=28
#SBATCH --output=/scratch/mb10856/MLIR-RL/logs/eval_jubail_%j.out
#SBATCH --error=/scratch/mb10856/MLIR-RL/logs/eval_jubail_%j.err
...
# Usage:
#   sbatch scripts/jubail_eval.sh config/v4_5.json
#   EVAL_LAST_ONLY=1 sbatch scripts/jubail_eval.sh config/v4_5.json
...
# Config Resolution
CONFIG="${1:-$PROJECT_ROOT/config/v4_5.json}"
if [[ "$CONFIG" != /* ]]; then
...
echo "=========================================="
echo "Jubail Evaluation started at $(date)"
echo "Implementation: $IMPLEMENTATION"
echo "Config:         $CONFIG_FILE_PATH"
echo "Resources:      28 CPUs, 32GB RAM"
echo "Constraint:     jubail"
