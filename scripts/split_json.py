...
Usage:
    python scripts/split_json.py --input data/all_base_exec_times.json
    python scripts/split_json.py --input data/all_base_exec_times.json --eval-ratio 0.15 --seed 123
