#!/bin/bash
#SBATCH --job-name=v4-train
#SBATCH --partition=compute
#SBATCH --time=12:00:00
#SBATCH --mem=64G
#SBATCH --cpus-per-task=8
#SBATCH --output=/scratch/tb3654/MLIR-RL/logs/v4_full_%j.out
#SBATCH --error=/scratch/tb3654/MLIR-RL/logs/v4_full_%j.err
...
export AUTOSCHEDULER_IMPL=rl_autoschedular_v4
export CONFIG_FILE_PATH=/scratch/tb3654/MLIR-RL/config/v4.json
